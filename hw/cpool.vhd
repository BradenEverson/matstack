            ...
            if EN = '1' then
                ...
                case ADDR is
                    ...
                    when 0 =>
                        ...
                        DATA.data(0)          <= x"3F800000";  -- 1.0
                        DATA.data(1)          <= x"40000000";  -- 2.0
                        DATA.data(2)          <= x"3F800000";  -- 1.0
                        DATA.data(3)          <= x"00000000";  -- 0.0
                        DATA.data(4)          <= x"3F800000";  -- 1.0
                        DATA.data(5)          <= x"00000000";  -- 0.0
                    ...
                    when 1 =>
                        ...
                        DATA.data(0)          <= x"40000000";  -- 2.0
                        DATA.data(1)          <= x"40A00000";  -- 5.0
                        DATA.data(2)          <= x"40C00000";  -- 6.0
                        DATA.data(3)          <= x"40E00000";  -- 7.0
                        DATA.data(4)          <= x"3F800000";  -- 1.0
                        DATA.data(5)          <= x"41000000";  -- 8.0
                        DATA.data(6 to MAX_ELEMENTS - 1) <= (others => x"00000000");
