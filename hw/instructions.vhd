...
package INSTRUCTIONS is
	...
	constant INSTR_GT: std_logic_vector(7 downto 0) := x"11";
	constant INSTR_LT: std_logic_vector(7 downto 0) := x"12";
	constant INSTR_SUM_REDUCE: std_logic_vector(7 downto 0) := x"13";
	constant INSTR_SUM: std_logic_vector(7 downto 0) := x"14";
	constant INSTR_LOAD_CONST: std_logic_vector(7 downto 0) := x"15";
	constant INSTR_LOAD_I: std_logic_vector(7 downto 0) := x"16";
	constant INSTR_CLONE_I: std_logic_vector(7 downto 0) := x"17";
	constant INSTR_STORE_I: std_logic_vector(7 downto 0) := x"18";
	constant INSTR_DROP: std_logic_vector(7 downto 0) := x"19";
	constant INSTR_BRANCH_ALWAYS: std_logic_vector(7 downto 0) := x"1A";
	constant INSTR_BRANCH_EQ: std_logic_vector(7 downto 0) := x"1B";
	constant INSTR_BRANCH_NE: std_logic_vector(7 downto 0) := x"1C";
	constant INSTR_DEBUG_PRINT: std_logic_vector(7 downto 0) := x"1D";
	constant INSTR_HALT: std_logic_vector(7 downto 0) := x"1E";
