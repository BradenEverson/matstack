...
The VM has been able to train off of the Fashion-MNIST dataset using a stochastic gradient descent implementation, this can be found in `lang/sample/fmnist`
